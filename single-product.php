...
?>
   	...
   	<div class="product-card col-sm-4">
		...
		<div class="product-details">
	 	...
	 	<div class="col-sm-8 product_desc_single">
	    <h3><?php echo $product_name ?></h3>
      <span>Price: <?php echo $product_sale_price ?></span>
	    <p><?php echo $product_desc ?></p>

	    <br/>

	    <div class="actions">
	    <button class="btn btn-info"><a href="single-product.php?id=<?php echo $id ?>&add_to_cart=<?php echo $id ?>">Add to Cart</a></button>
	    </div>
        </div>
