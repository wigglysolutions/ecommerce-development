...
<html>
  ...
  <input class="form-control" name="category_name" type="text" placeholder="Category Name" /><br/>
...
$query = $pdo->prepare("INSERT INTO categories(cat_name) VALUES('$category_name')");
